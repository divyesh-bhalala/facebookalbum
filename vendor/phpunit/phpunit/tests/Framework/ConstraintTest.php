...
EOF
    ...
    public function testConstraintException()
    {
        ...
        $exception = new DummyException('Tests');
        ...
        try {
            ...
            $this->assertEquals(
              <<<EOF
Failed asserting that exception of type "DummyException" matches expected exception "FoobarException". Message was: "Tests" at
$stackTrace.
